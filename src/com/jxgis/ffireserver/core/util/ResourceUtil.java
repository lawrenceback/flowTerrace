...
public class ResourceUtil {
	 ...
	 * @return
	 */
	public static String getRequestPath(HttpServletRequest request, int fetchType) {
	...
	public static void main(String[] args) {
		com.jxgis.ffireserver.core.util.LogUtil.info(getPorjectPath());
		com.jxgis.ffireserver.core.util.LogUtil.info(getSysPath());
	}
