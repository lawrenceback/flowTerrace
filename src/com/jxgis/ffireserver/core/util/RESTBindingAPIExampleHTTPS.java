...
public class RESTBindingAPIExampleHTTPS {
	...
	public static void main(String[] args) {
		try {
			System.out.println(RESTBindingAPIExampleHTTPS.sendPost("https://maps.googleapis.com/maps/api/js?key=AIzaSyDk_bOqPj0RnQdpjJ01aPHeiyr20feUTMI&callback=initMap", ""));
		} catch (Exception e) {
