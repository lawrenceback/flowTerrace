...
public class JavaSmsApi {
	private static final String APIKEY_YPW = "a288a6f96cc490900a9bc0e0c981e8dc";
	private static final long TPL_ID = 1796540;
	//查账户信息的http地址
	...
	public static void main(String[] args) throws IOException, URISyntaxException {
		...
		String apikey = "a288a6f96cc490900a9bc0e0c981e8dc";

		//修改为您要发送的手机号
		String mobile = "13479575392";
...
//		System.out.println(JavaSmsApi.tplSendSms(apikey, tpl_id, tpl_value, mobile));
	...
	public static boolean sendCode(String mobile,String code) throws IOException, URISyntaxException {
		//设置模板ID，如使用1号模板:【#company#】您的验证码是#code#
		...
		//模板发送的调用示例
		JSONObject js = JSONObject.fromObject(JavaSmsApi.tplSendSms(APIKEY_YPW, TPL_ID, tpl_value, mobile));
