		...
		<div class="row">
			<div class="col-sm-12 animated fadeInUp">
				<form method="post" class="form-horizontal" name="form1" id="form1">
					...
					<div class="form-group">
						<label class="col-xs-2 col-xs-offset-2 control-label" for="waveband">波段</label>

						<div class="col-xs-8 col-md-6 col-md-6">
							<input type="text" class="form-control" name="waveband" id="waveband" placeholder="波段">
					...
					<div class="form-group">
						<label class="col-xs-2 col-xs-offset-2 control-label" for="antdiameter">天线直径</label>

						<div class="col-xs-8 col-md-6 col-md-6">
							<input type="text" class="form-control" name="antdiameter" id="antdiameter" placeholder="天线直径">
