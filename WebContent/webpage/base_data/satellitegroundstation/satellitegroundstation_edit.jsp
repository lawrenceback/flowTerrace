	...
	<div class="row">
		<div class="col-sm-12 animated fadeInUp">
			<form method="post" class="form-horizontal" name="form1" id="form1">
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="waveband">天线直径</label>

					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="waveband" id="waveband" placeholder="天线直径">
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="ip">IP地址</label>
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="shape">Geometry</label>
...
<script>
	...
	function setVlue(callback) {
		...
		$('#waveband').val( data_tr.waveband );
		$('#antdiameter').val( data_tr.antdiameter );
		$('#ip').val( data_tr.ip );
	...
	function _submit(form){
		...
		formData.append("waveband",  $form.find('input[name="waveband"]').val() );
		formData.append("antdiameter",  $form.find('input[name="antdiameter"]').val() );
