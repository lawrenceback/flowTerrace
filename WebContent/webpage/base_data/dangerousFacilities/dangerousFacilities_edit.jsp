	...
	<div class="row">
		<div class="col-sm-12 animated fadeInUp">
			<form method="post" class="form-horizontal" name="form1" id="form1">
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="content">重要设施或危险品名称</label>

					<div class="col-xs-8 col-md-4 col-md-4">
						<textarea name="content" id="content" rows="4" class="form-control" placeholder="content"></textarea>
					</div>
				</div>
				<div class="hr-line-dashed"></div>
