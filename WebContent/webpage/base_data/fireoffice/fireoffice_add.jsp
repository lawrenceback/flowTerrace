		...
		<div class="row">
			<div class="col-sm-12 animated fadeInUp">
				<form method="post" class="form-horizontal" name="form1" id="form1">
					...
					<div class="form-group">
						<label class="col-xs-2 col-xs-offset-2 control-label"  >机构编制</label>
					...
					<div class="form-group">
						<label class="col-xs-2 col-xs-offset-2 control-label"  >级别</label>
						...
						<div class="col-xs-8 col-md-6 col-md-6">
							...
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="level" id="level2" value="level2" checked>
									市级
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="level" id="level3" value="level3" checked>
									县级
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="level" id="level4" value="level4" checked>
									其他
								</label>
							</div>
						</div>
