	...
	<div class="row">
		<div class="col-sm-12 animated fadeInUp">
			<form method="post" class="form-horizontal" name="form1" id="form1">
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="director">办公室主任</label>
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="dir_phone">主任电话</label>

					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="dir_phone" id="dir_phone" placeholder="dir_phone">
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="num_people">机构人数</label>

					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="num_people" id="num_people" placeholder="num_people">
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="institutions">机构编制</label>

					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="institutions" id="institutions" placeholder="institutions">
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="level">级别</label>
...
<script>
	...
	function setVlue(callback) {
		...
		$('#num_people').val( data_tr.num_people );
	...
	function _submit(form){
		...
		formData.append("dir_phone", $form.find('input[name="dir_phone"]').val() );
		formData.append("longitude", $form.find('input[name="longitude"]').val() );
		formData.append("latitude", $form.find('input[name="latitude"]').val() );
		formData.append("num_people", $form.find('input[name="num_people"]').val() );
		formData.append("institutions", $form.find('input[name="institutions"]').val() );
		formData.append("type", $form.find('input[name="type"]').val() );
		formData.append("level", $form.find('input[name="level"]').val() );
