				...
				<form method="post" class="form-horizontal" name="form1" id="form1">
					...
					<div class="form-group">
						...
						<div class="col-xs-8 col-md-6 col-md-6">
							<input type="number" class="form-control" name="longitude" id="longitude" placeholder="经度">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-8 col-md-6 col-md-6">
							<input type="number" class="form-control" name="latitude" id="latitude" placeholder="纬度">
						</div>
					</div>
					<div class="hr-line-dashed"></div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="col-xs-2 col-xs-offset-2 control-label" for="row_spacing">株行距</label>

						<div class="col-xs-8 col-md-6 col-md-6">
							<input type="number" class="form-control" name="row_spacing" id="row_spacing" placeholder="株行距">
							<span class="prafont poa">米</span>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-xs-2 col-xs-offset-2 control-label"  >营造单位</label>


						<div class="col-xs-8 col-md-6 col-md-6">
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="build_unit" id="build_unit1" value="build_unit1" checked>
									林业局
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="build_unit" id="build_unit2" value="build_unit2">
									林场
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="build_unit" id="build_unit3" value="build_unit3"  >
									村庄
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="build_unit" id="build_unit4" value="build_unit4"  >
									个体
								</label>
							</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-8 col-md-6 col-md-6">
							<input type="text" class="form-control" name="build_year" id="build_year" placeholder="营造年度">
						</div>
					</div>
					<div class="hr-line-dashed"></div>
					...
					<div class="form-group">
						...
						<div class="col-xs-8 col-md-6 col-md-6">
							...
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="type" id="type5" value="type5"  >
									防火道路
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="type" id="type6" value="type6"  >
									其它阻隔带
								</label>
							</div>
						</div>
