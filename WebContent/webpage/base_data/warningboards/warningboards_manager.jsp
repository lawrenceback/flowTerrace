...
<div class="ibox ibox-datagrid">
    ...
    <div class="ibox-title">
        ...
        <div class="ibox-tools ibox-tools-one">
            <a onclick="add()"><i class="fa fa-plus"></i> 添加警示牌</a>
            ...
            <ul class="dropdown-menu bg-warning" aria-labelledby="dLabel" id="cols">
                ...
                <li><div class="checkbox i-checks"><label><input type="checkbox" property="content"><i></i>主要内容</label></div></li>

                <li><div class="checkbox i-checks"><label><input type="checkbox" checked property="status"><i></i>状态</label></div></li>
                <li><div class="checkbox i-checks"><label><input type="checkbox" checked property="note"><i></i>说明</label></div></li>
                <li><div class="checkbox i-checks"><label><input type="checkbox" checked property="build_year"><i></i>建设年度</label></div></li>
                <li><div class="checkbox i-checks"><label><input type="checkbox" checked property="build_unit"><i></i>建设单位</label></div></li>
                <li><div class="checkbox i-checks"><label><input type="checkbox" checked property="type"><i></i>类型</label></div></li>

                <li><div class="checkbox i-checks"><label><input type="checkbox" checked property="number"><i></i>编号</label></div></li>
                <li><div class="checkbox i-checks"><label><input type="checkbox" checked property="management_unit"><i></i>管理单位</label></div></li>
                <li><div class="checkbox i-checks"><label><input type="checkbox" checked property="pac"><i></i>行政区划代码</label></div></li>
        ...
        <div id="tr_datagrid_list" class="map_data_table" style="height: calc(100% - 50px);">
            ...
            <div class="datagrid-talbe form-datagrid">
                ...
                <table class="table table-bordered table-hover" id="hot_list">
                    <thead>
                    <tr>
                        <th data-property="checkbox" style="width:45px;"><div class="checkbox i-checks checkbox_all"><label><input type="checkbox" class="checkbox_all_input" property="row"><i></i></label></div></th>
                        ...
                        <th class="sort" data-property="content">主要内容<i class="iconfont icon-paixu"></i></th>
                        ...
                        <th class="sort" data-property="build_year">建设年度<i class="iconfont icon-paixu"></i></th>
                        <th class="sort" data-property="build_unit">建设单位<i class="iconfont icon-paixu"></i></th>
...
<script>
	...
	function add() {
		layer.open({
			...
			area: ['100%', '100%'],
			content: cg_vte.path + 'webpage/base_data/warningboards/warningboards_add.jsp',
			btn: ['关闭'],
			fix: false,
			scrollbar: false,
	...
	function edit(item) {
		...
		layer.open({
			...
			maxmin: false, //开启最大化最小化按钮
			area: ['100%', '100%'],
			content: cg_vte.path + 'webpage/base_data/warningboards/warningboards_edit.jsp',
			btn: ['关闭'],
			fix: false,
			scrollbar: false,
			yes: function (index, layero) {layer.close( index );}
...
//		var roadNetLayer = new AMap.TileLayer.RoadNet({zIndex:9}); //实例化路网图层
        ...
        for(var i in rows){
            if (rows.hasOwnProperty(i)){
                ...
                AMap.event.addListener(marker, 'click', function(event) {
                    ...
                    info.push("<br>");
                    info.push("主要内容 : {content}");
                    info.push("<br>");

                    info.push("建设年度： {build_year}");
                    info.push("<br>");
                    info.push("建设单位： {build_unit}");
                    info.push("</div>");
