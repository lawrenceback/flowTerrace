					...
					<div class="col-sm-12">
						...
						<form method="post" class="form-horizontal" name="form1" id="form1">
							...
							<div class="form-group">
								<label class="col-xs-4 control-label" for="no">编号</label>

								<div class="col-xs-6">
									<input type="text" class="form-control" name="no" id="no" placeholder="编号" >
								</div>
							</div>

							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-xs-4 control-label" for="satellite">接收卫星</label>

								<div class="col-xs-6">
									<input type="text" class="form-control" name="satellite" id="satellite" placeholder="接收卫星">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-xs-4 control-label" for="county">县</label>

								<div class="col-xs-6">
									<input type="text" class="form-control" name="county" id="county" placeholder="县">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
							...
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-xs-4 control-label" for="reporter">报告者</label>

								<div class="col-xs-6">
									<input type="text" class="form-control" name="reporter" id="reporter" placeholder="报告者">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-xs-6">
									<input type="text" class="form-control" name="reporttime" id="reporttime" placeholder="reporttime">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							...
							<div class="form-group">
								...
								<div class="col-xs-6">
									<input type="text" class="form-control" name="receiptt" id="receiptt" placeholder="receiptt">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							...
							<div class="form-group">
								...
								<div class="col-xs-6">
									<input type="text" class="form-control" name="landtype" id="landtype" placeholder="landtype">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
...
<script>
	...
	function setVlue(callback) {
		...
		$('#id').val( data_tr.id );
		$('#continuous').val( data_tr.continuous );
		$('#county').val( data_tr.county );
		$('#duty').val( data_tr.duty );
		$('#landtype').val( data_tr.landtype );
		$('#latitude').val( data_tr.latitude );
		$('#longitude').val( data_tr.longitude );
		$('#no').val( data_tr.no );
		$('#note').val( data_tr.note );
		$('#opinion').val( data_tr.opinion );
		$('#pixels').val( data_tr.pixels );
		$('#receiptt').val( data_tr.receiptt.substring(0,10) );
		$('#reporter').val( data_tr.reporter );
		$('#reporttime').val( data_tr.reporttime.substring(0,10) );
		$('#satellite').val( data_tr.satellite );
		$('#shape').val( data_tr.shape );
		$('#smoke').val( data_tr.smoke );
		$('#source').val( data_tr.source );
