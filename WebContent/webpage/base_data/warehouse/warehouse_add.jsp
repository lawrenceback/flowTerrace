		...
		<div class="row">
			<div class="col-sm-12 animated fadeInUp">
				<form method="post" class="form-horizontal" name="form1" id="form1">
					...
					<div class="form-group">
						<label class="col-xs-2 col-xs-offset-2 control-label"  >所属编号</label>
						...
						<div class="col-xs-8 col-md-6 col-md-6">
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios" id="user_id1" value="user_id1" checked>
									防火办
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios" id="user_id2" value="user_id2">
									森林防火指挥部
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios" id="user_id3" value="user_id3"  >
									专业森林消防队
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios" id="user_id4" value="user_id4"  >
									半专业森林消防对
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios" id="user_id5" value="user_id5"  >
									乡镇扑火应急队
								</label>
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-8 col-md-6 col-md-6">
							...
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios" id="type5" value="type5"  >
									乡镇级物质储备库
								</label>
							</div>
						</div>
