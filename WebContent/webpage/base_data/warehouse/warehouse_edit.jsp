		...
		<div class="col-sm-12 animated fadeInUp">
			<form method="post" class="form-horizontal" name="form1" id="form1">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="typeid" id="typeid" placeholder="typeid">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="mat_id" id="mat_id" placeholder="mat_id">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="build_year" id="build_year" placeholder="build_year">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="build_area" id="build_area" placeholder="build_area">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="reserve_type" id="reserve_type" placeholder="reserve_type">
...
<script>
	...
	function setVlue(callback) {
		...
		$('#typeid').val( data_tr.typeid );
		$('#user_id').val( data_tr.user_id );
		$('#mat_id').val( data_tr.mat_id );
		$('#build_year').val( data_tr.build_year );
		$('#build_area').val( data_tr.build_area );
		$('#status').val( data_tr.status );
		$('#note').val( data_tr.note );
		$('#type').val( data_tr.type );
		$('#management_unit').val( data_tr.management_unit );
		$('#director').val( data_tr.director );
		$('#reserve_type').val( data_tr.reserve_type );
		$('#quantity').val( data_tr.quantity );
	...
	function _submit(form){
		...
		formData.append("typeid",  $form.find('input[name="typeid"]').val() );
		formData.append("user_id",  $form.find('input[name="user_id"]').val() );
		formData.append("mat_id",  $form.find('input[name="mat_id"]').val() );
		formData.append("build_year",  $form.find('input[name="build_year"]').val() );
		formData.append("build_area",  $form.find('input[name="build_area"]').val() );
		...
		formData.append("director",  $form.find('input[name="director"]').val() );
		formData.append("reserve_type",  $form.find('input[name="reserve_type"]').val() );
		formData.append("quantity",  $form.find('input[name="quantity"]').val() );
