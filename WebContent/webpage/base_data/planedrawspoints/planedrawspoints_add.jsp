		...
		<div class="row">
			<div class="col-sm-12 animated fadeInUp">
				<form method="post" class="form-horizontal" name="form1" id="form1">
					...
					<div class="form-group">
						<label class="col-xs-2 col-xs-offset-2 control-label" for="type1">类型</label>

						<div class="col-xs-8 col-md-6 col-md-6">
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios" id="type1" value="type1" checked>
									水库
								</label>
							</div>
							<div class="radio fl mr20">
					...
					<div class="form-group">
						<label class="col-xs-2 col-xs-offset-2 control-label"  >是否有电线索道</label>

						<div class="col-xs-8 col-md-6 col-md-6">
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios1" id="is_cableway1" value="is_cableway1" checked>
									是
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios1" id="is_cableway2" value="is_cableway2">
									否
								</label>
							</div>
					...
					<div class="form-group">
						<label class="col-xs-2 col-xs-offset-2 control-label" >是否有网箱养鱼</label>

						<div class="col-xs-8 col-md-6 col-md-6">
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios2" id="is_cage_fish1" value="is_cage_fish1" checked>
									是
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios2" id="is_cage_fish2" value="is_cage_fish2">
									否
								</label>
							</div>
					...
					<div class="form-group">
						<label class="col-xs-2 col-xs-offset-2 control-label"  >能否吊桶取水</label>

						<div class="col-xs-8 col-md-6 col-md-6">
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios3" id="is_take_water1" value="is_take_water1" checked>
									是
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios3" id="is_take_water2" value="is_take_water2">
									否
								</label>
							</div>
