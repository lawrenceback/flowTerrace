		...
		<div class="col-sm-12 animated fadeInUp">
			<form method="post" class="form-horizontal" name="form1" id="form1">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="storage_area" id="storage_area" placeholder="蓄水面积">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="storage_capacity" id="storage_capacity" placeholder="蓄水容量">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="maximum_depth" id="maximum_depth" placeholder="最大深度">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="traffic_condition" id="traffic_condition" placeholder="交通情况">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="is_cableway" id="is_cableway" placeholder="是否有电线索道">
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="is_cage_fish">是否有网箱养鱼</label>

					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="is_cage_fish" id="is_cage_fish" placeholder="是否有网箱养鱼">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="is_take_water" id="is_take_water" placeholder="能否吊桶取水">
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="note">备注</label>
...
<script>
	...
	function setVlue(callback) {
		...
		$('#is_cage_fish').val( data_tr.is_cage_fish );
		$('#is_take_water').val( data_tr.is_take_water );
		$('#note').val( data_tr.note );
		$('#number').val( data_tr.number );
	...
	function _submit(form){
		...
		formData.append("is_cableway",  $form.find('input[name="is_cableway"]').val() );
		formData.append("is_cage_fish",  $form.find('input[name="is_cage_fish"]').val() );
		formData.append("is_take_water",  $form.find('input[name="is_take_water"]').val() );
