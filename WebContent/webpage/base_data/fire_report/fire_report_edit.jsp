		...
		<div class="col-sm-12 animated fadeInUp">
			<form method="post" class="form-horizontal" name="form1" id="form1">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="start_addr" id="start_addr" placeholder="start_addr">
					</div>
				</div>
				<div class="hr-line-dashed"></div>
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="stop_addr" id="stop_addr" placeholder="stop_addr">
					</div>
				</div>
				<div class="hr-line-dashed"></div>
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="build_addr" id="build_addr" placeholder="build_addr">
					</div>
				</div>
				<div class="hr-line-dashed"></div>
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="date" class="form-control" name="build_year" id="build_year" placeholder="build_year">
					</div>
				</div>
				<div class="hr-line-dashed"></div>
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="build_unit" id="build_unit" placeholder="build_unit">
					</div>
				</div>
				<div class="hr-line-dashed"></div>
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="tree_type" id="tree_type" placeholder="tree_type">
					</div>
				</div>
				<div class="hr-line-dashed"></div>
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="number" class="form-control" name="belt_len" id="belt_len" placeholder="belt_len">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="number" class="form-control" name="belt_width" id="belt_width" placeholder="belt_width">
						<span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 只允许输入数字</span>
					</div>
				</div>
				<div class="hr-line-dashed"></div>
