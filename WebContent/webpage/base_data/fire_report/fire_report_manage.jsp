				...
				<div class="ibox ibox-datagrid">
					...
					<div class="ibox-title">
						...
						<div class="ibox-tools ibox-tools-one">
							<a onclick="add()"  ><i class="fa fa-plus"></i> 添加火情</a>
							...
							<ul class="dropdown-menu bg-warning" aria-labelledby="dLabel" id="cols">
								...
								<li><div class="checkbox i-checks"><label><input type="checkbox" property="age"><i></i>火情上报员年龄</label></div></li>
								<li><div class="checkbox i-checks"><label><input type="checkbox" property="description"><i></i>description</label></div></li>
								<li><div class="checkbox i-checks"><label><input type="checkbox" property="duty"><i></i>值班员</label></div></li>
								<li><div class="checkbox i-checks"><label><input type="checkbox" checked property="fireFighting"><i></i>fireFighting</label></div></li>
								<li><div class="checkbox i-checks"><label><input type="checkbox" checked property="fireType"><i></i>fireType</label></div></li>
								...
								<li><div class="checkbox i-checks"><label><input type="checkbox" property="occupation"><i></i>火情上报员职业</label></div></li>
								<li><div class="checkbox i-checks"><label><input type="checkbox" property="phone"><i></i>火情上报员电话</label></div></li>
								<li><div class="checkbox i-checks"><label><input type="checkbox" property="place"><i></i>火情发生的小地名</label></div></li>
								<li><div class="checkbox i-checks"><label><input type="checkbox" checked property="reporter"><i></i>火情上报人员</label></div></li>
								<li><div class="checkbox i-checks"><label><input type="checkbox" checked property="status"><i></i>状态</label></div></li>
								<li><div class="checkbox i-checks"><label><input type="checkbox" checked property="time"><i></i>time</label></div></li>
								<li><div class="checkbox i-checks"><label><input type="checkbox" property="type"><i></i>type</label></div></li>
							</ul>
							...
							<div class="datagrid-talbe form-datagrid">
								<table class="table table-bordered table-hover" id="hot_list">
									...
									<tr>
										...
										<th class="sort" data-property="age">火情上报员年龄<i class="iconfont icon-paixu"></i></th>
										<th class="sort" data-property="description">description<i class="iconfont icon-paixu"></i></th>
										<th class="sort" data-property="duty">值班员<i class="iconfont icon-paixu"></i></th>
										<th class="sort" data-property="fireFighting">fireFighting<i class="iconfont icon-paixu"></i></th>
										<th class="sort" data-property="fireType">fireType<i class="iconfont icon-paixu"></i></th>
										...
										<th class="sort" data-property="occupation">火情上报员职业<i class="iconfont icon-paixu"></i></th>
										<th class="sort" data-property="phone">火情上报员电话<i class="iconfont icon-paixu"></i></th>
										<th class="sort" data-property="place">火情发生的小地名<i class="iconfont icon-paixu"></i></th>
										<th class="sort" data-property="reporter">火情上报人员<i class="iconfont icon-paixu"></i></th>
										<th class="sort" data-property="state">state<i class="iconfont icon-paixu"></i></th>
										<th class="sort" data-property="time">time<i class="iconfont icon-paixu"></i></th>
										<th class="sort" data-property="type">type<i class="iconfont icon-paixu"></i></th>
...
<script>
				...
				for (var i = 0; i < data_length; i++) {
					if (data.hasOwnProperty(i)) {
						var sub = temp.temp_hot_list.format({
							...
							fireFighting: data[i].fireFighting || '',
	...
	function add() {
		layer.open({
			...
			area: ['100%', '100%'],
			content: cg_vte.path + 'webpage/base_data/fire_report/fire_report_add.jsp',
			fix: false,
			scrollbar: false,
		});
	}
        ...
        for(var i in rows){
            if (rows.hasOwnProperty(i)){
                ...
                AMap.event.addListener(marker, 'click', function(event) {
                    ...
                    info.push("<br>");
                    info.push("火情发生的小地名： {place}");
                    info.push("<br>");
                    info.push("火情上报人员： {reporter}");
    ...
    function mapDatail() {
        ...
        content = content.format({
            ...
            state: function () {
                switch (data.state){
                    case 1: return '新接收到的火情 ';
                    case 2: return '已经存档并结束的火情 ';
                    case 3: return '调度结束并已经正式形成火灾的火情  ';
                    default: return ' ';
                }
            },
		...
		<div class="ibox">
			<div class="ibox-content">
				<table class="table table-bordered this_map_data">
					<tr>
						<td style="width:140px;"> 用户登陆帐号</td>
