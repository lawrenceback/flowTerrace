	...
	<div class="row">
		<div class="col-sm-12 animated fadeInUp">
			<form method="post" class="form-horizontal" name="form1" id="form1">
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="volume">容积量</label>
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="storage_area">蓄水面积</label>

					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="storage_area" id="storage_area" placeholder="storage_area">
					</div>
				</div>
				<div class="hr-line-dashed"></div>

				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="storage_capacity">蓄水容量</label>

					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="storage_capacity" id="storage_capacity" placeholder="storage_capacity">
					</div>
				</div>
				<div class="hr-line-dashed"></div>

				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="maximum_depth">最大深度</label>

					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="maximum_depth" id="maximum_depth" placeholder="maximum_depth">
					</div>
				</div>
				<div class="hr-line-dashed"></div>
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="management_unit" id="management_unit" placeholder="management_unit">
					</div>
				</div>
				<div class="hr-line-dashed"></div>

				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="traffic_condition">交通情况</label>

					<div class="col-xs-8 col-md-4 col-md-4">
						<input type="text" class="form-control" name="traffic_condition" id="traffic_condition" placeholder="traffic_condition">
					</div>
				</div>
				<div class="hr-line-dashed"></div>

				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="is_cableway">是否有电线索道</label>

					<div class="col-xs-8 col-md-4 col-md-4">
						<select name="is_cableway" id="is_cableway" class="form-control">
				...
				<div class="form-group">
					<label class="col-xs-2 col-xs-offset-2 control-label" for="is_take_water">能否吊桶取水</label>

					<div class="col-xs-8 col-md-4 col-md-4">
						<select name="is_take_water" id="is_take_water" class="form-control">
							<option value="1">是</option>
							<option value="2">否</option>
						</select>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-md-4 col-md-4">
						<textarea name="note" id="note" rows="4" class="form-control" placeholder="note"></textarea>
					</div>
				</div>
				<div class="hr-line-dashed"></div>
...
<script>
	...
	function setVlue(callback) {
		...
		$('#volume').val( data_tr.volume );
		$('#shape').val( data_tr.shape );
		$('#status').val( data_tr.status );
		$('#storage_area').val( data_tr.storage_area );
		$('#storage_capacity').val( data_tr.storage_capacity );
		$('#maximum_depth').val( data_tr.maximum_depth );
		$('#management_unit').val( data_tr.management_unit );
		$('#traffic_condition').val( data_tr.traffic_condition );
		$('#is_cableway').val( data_tr.is_cableway );
		$('#is_take_water').val( data_tr.is_take_water );
	...
	function _submit(form){
		...
		formData.append("volume", $form.find('input[name="volume"]').val() );
		formData.append("shape", $form.find('input[name="shape"]').val() );
		formData.append("status", $form.find('select[name="status"]').val() );
		formData.append("storage_area", $form.find('input[name="storage_area"]').val() );
		formData.append("storage_capacity", $form.find('input[name="storage_capacity"]').val() );
		formData.append("maximum_depth", $form.find('input[name="maximum_depth"]').val() );
		formData.append("management_unit", $form.find('input[name="management_unit"]').val() );
		formData.append("traffic_condition", $form.find('input[name="traffic_condition"]').val() );
		formData.append("is_cableway", $form.find('select[name="is_cableway"]').val() );
		formData.append("is_take_water", $form.find('select[name="is_take_water"]').val() );
