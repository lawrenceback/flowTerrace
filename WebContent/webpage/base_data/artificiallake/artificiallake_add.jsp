		...
		<div class="row">
			<div class="col-sm-12 animated fadeInUp">
				<form method="post" class="form-horizontal" name="form1" id="form1">
					...
					<div class="form-group">
						<label class="col-xs-4 control-label" for="manager">管理员</label>
					...
					<div class="form-group">
						<label class="col-xs-4 control-label" for="phone">管理员电话</label>
					...
					<div class="form-group">
						<label class="col-xs-4 control-label" for="volume">容积量</label>

						<div class="col-xs-8 col-md-6 col-md-6 por">
							<input type="text" class="form-control" name="volume" id="volume" placeholder="容积量">
							<span class="prafont poa">m³</span>
						</div>
					</div>
					<div class="hr-line-dashed"></div>

					<div class="form-group">
						<label class="col-xs-4 control-label" for="storage_area">蓄水面积</label>
					...
					<div class="form-group">
						<label class="col-xs-4 control-label" for="storage_capacity">蓄水容量</label>
					...
					<div class="form-group">
						<label class="col-xs-4 control-label" for="maximum_depth">最大深度</label>
					...
					<div class="form-group">
						<label class="col-xs-4 control-label" for="management_unit">管理单位</label>
					...
					<div class="form-group">
						<label class="col-xs-4 control-label" for="traffic_condition">交通情况</label>
					...
					<div class="form-group">
						<label class="col-xs-4 control-label" for="is_cableway">是否有电线索道</label>
					...
					<div class="form-group">
						<label class="col-xs-4 control-label"  >能否吊桶取水</label>


						<div class="col-xs-8 col-md-6 col-md-6">
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios" id="is_take_water1" value="is_take_water1" checked>
									是
								</label>
							</div>
							<div class="radio fl mr20">
								<label>
									<input type="radio" name="optionsRadios" id="is_take_water2" value="is_take_water2">
									否
								</label>
							</div>
					...
					<div class="form-group">
						<label class="col-xs-4 control-label" for="note">说明</label>

						<div class="col-xs-8 col-md-6 col-md-6">
							<textarea name="note" id="note" rows="4" class="form-control" placeholder="说明"></textarea>
						</div>
					</div>
					<div class="hr-line-dashed"></div>
					...
					<div class="form-group">
						...
						<div class="col-xs-8 col-md-6 col-md-6">
							<textarea class="form-control" name="shape" id="shape" placeholder="几何" rows="3"></textarea>
					...
					<div class="form-group">
						<label for="province" class="col-xs-4 control-label">行政区</label>
