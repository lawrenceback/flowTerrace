				...
				<div class="col-sm-12">
					...
					<form method="post" class="form-horizontal" name="form1" id="form1">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="iconName" id="iconName" placeholder="名称">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="iconClass" id="iconClass" placeholder="图标样式代码">
								<span class="help-block m-b-none"></span>
							</div>
						</div>
