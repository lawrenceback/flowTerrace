				...
				<form method="post" class="form-horizontal" name="form1" id="form1">
					...
					<div class="form-group">
						...
						<div class="col-xs-8 col-md-4 col-md-4">
							<input type="text" class="form-control" name="code" id="code" placeholder="code" disabled>
						</div>
					</div>
